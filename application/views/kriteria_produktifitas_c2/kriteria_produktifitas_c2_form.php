    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA KRITERIA_PRODUKTIFITAS_C2</h3>
            </div>
...
<table class='table table-bordered>'        
	    ...
	    <a href="<?php echo site_url('kriteria_produktifitas_c2') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>