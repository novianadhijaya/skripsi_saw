    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA KRITERIA_ABSENSI_C1</h3>
            </div>
...
<table class='table table-bordered>'        
	    ...
	    <a href="<?php echo site_url('kriteria_absensi_c1') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>